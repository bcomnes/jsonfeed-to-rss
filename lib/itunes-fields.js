...
function getSummary (obj) {
  return truncate4k(get(obj, '_itunes.summary') || get(obj, 'summary') || truncate4k(getFirstParagraph(obj.description || obj.text_content || striptags(obj.html_content))))
}
...
function getSubtitle (obj) {
  return truncate250(get(obj, '_itunes.subtitle') || get(sentenceSplitter.split(getSummary(obj) || '').find(obj => obj.type === 'Sentence'), 'raw'))
}
